...
export const gridItems = [
  {
    id: 1,
    title: "I prioritize collaboration, encouraging open dialogue",
    description: "",
  ...
  {
    id: 2,
    title: "I'm flexible with communications across time zones",
    description: "",
  ...
  },
  {
    id: 3,
    title: "My tech stack",
    description: "I'm always adding to",
    className: "lg:col-span-2 md:col-span-3 md:row-span-2",
    imgClassName: "",
  ...
  {
    id: 5,
    title: "Currently building a new ThreeJS custom interactive portfolio",
